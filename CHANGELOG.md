...
- **Workbench file history**: right-click a file in Explorer to inspect commits across all local and remote-tracking branches, including history before file renames ("文件历史" / "File History")
