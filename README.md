...
Desktop version: **0.1.1** · [Changelog](CHANGELOG.md) · [All releases](https://github.com/lucacicii/agent-resume-desktop-doc/releases) · Extension: **2.6.6**
...
桌面端版本：**0.1.1** · [更新日志](CHANGELOG.md) · [全部 Releases](https://github.com/lucacicii/agent-resume-desktop-doc/releases) · 扩展：**2.6.6**
