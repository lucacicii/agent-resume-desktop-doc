...
5. Hide / unhide or rename may be available depending on version — prefer Workbench for resume.
...
Full extension session docs: [panel-doc Sessions](https://github.com/lucacicii/agent-resume-panel-doc/blob/main/sessions.md).
...
5. 隐藏 / 取消隐藏或重命名视版本提供 — 恢复会话优先用 Workbench。
...
扩展侧完整说明：[panel-doc Sessions](https://github.com/lucacicii/agent-resume-panel-doc/blob/main/sessions.md)。

### 提示

1. Sessions 适合 **查找** 历史，不必离开回顾语境。  
2. 需要实时终端时用 Workbench。  
3. 默认路径不对时，在 **Settings → Sessions** 配置 Agent 目录。
